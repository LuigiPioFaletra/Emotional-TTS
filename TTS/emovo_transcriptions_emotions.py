...
def create_emovo_metadata(input_dir, output_csv):
    """
    Estrae metadati dai file audio EMOVO e salva un CSV con le colonne: nome del file, trascrizione associata (in base al codice frase), emozione (in italiano, es: 'sorpresa', 'rabbia', 'gioia').
    """
    frasi = {
        ...
        "n5": "Uno quarantatrè dieci mille cinquantasette venti.",
