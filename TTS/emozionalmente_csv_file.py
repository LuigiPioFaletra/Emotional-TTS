...
def create_emozionalmente_metadata(input_csv, output_csv, emotion_map):
    """
    Estrae metadati dal dataset Emozionalmente e genera un CSV con le colonne: dataset_name (valore fisso: "Emozionalmente"), file_name, transcription, speaker_id (ex 'actor'), emotion (in italiano).
    """
    righe = []
